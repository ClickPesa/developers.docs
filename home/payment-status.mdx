...
| Status     | Description                                                                                     |
|------------|-------------------------------------------------------------------------------------------------|
| `SUCCESS`    | Successfully made payment that has not been settled to the merchant account yet.              |
...
2. **Querying** - Alternatively, you can make API calls periodically to [Collection API](/collection-api/collection-api-overview) query payment endpoint.
...
- Additionally, the final payment status is sent to the customer via their registered email or mobile phone number.
