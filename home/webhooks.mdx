...
| **Application webhooks** | Transactions for a specific application | Collection API, Disbursement API, [BillPay API](/bill-pay/billpay-api-overview), and hosted checkout or payout links |
...
- **Hosted integrations** — payments and payouts through hosted links for your application, such as [Hosted Checkout](/checkout/hosted-checkout/hosted-checkout)
