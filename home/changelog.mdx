...
- **Activate Direct Debit** from **Settings → Collection** or **Get Started → Payment Methods** (KYC required; one-time activation fee **250,000 TZS**)
...
- **Merchant notifications** when a mandate is requested, approved, rejected, or cancelled
- **Documentation:** New [CRDB Direct Debit guides](/crdb-direct-debit/crdb-direct-debit-overview), [Payment Plans](/crdb-direct-debit/payment-plans), and [API reference](/crdb-direct-debit/api-overview)
