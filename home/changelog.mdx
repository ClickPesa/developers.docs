...
<Update label="July 2026" tags={["Improvements", "KYC", "API", "Merchant Dashboard"]} rss={{ title: "Monthly Updates", description: "July 2026 - Product updates and improvements" }}>
...
- **Premium features:** Card collections and several collection channel activations stay unavailable until KYC is complete.
