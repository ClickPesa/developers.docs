...
| | **TanQR/Lipa Namba** | **BillPay** | **CRDB Direct Debit** |
| --- | --- | --- | --- |
| **What the customer uses** | Your QR code or Lipa Namba | A BillPay control number | Approves a bank mandate on their CRDB account |
| **How they pay** | Scan QR, or pay via USSD and bank channels using your Lipa Namba | Pay via mobile money USSD, SIM banking, or bank channels using the control number | Scheduled debits from their CRDB account after mandate approval |
| **Best for** | Store collections — physical and online | Deposits, order payments, invoices, and customer-specific references | Installments, subscriptions, and recurring agreements |
| **Setup** | [Merchant Dashboard](/tan-qr/lipa-namba-setup) | [Merchant Dashboard](/bill-pay/billpay-namba) or [BillPay API](/bill-pay/billpay-api-overview) | [Merchant Dashboard](/crdb-direct-debit/setup) or [Direct Debit API](/crdb-direct-debit/api-overview) |
