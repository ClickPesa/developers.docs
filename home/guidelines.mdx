...
**ClickPesa Collection API**

For businesses that need to collect payments programmatically. A betting company can use the Collection API to collect bets and process payments from clients instantly.
