...
**Mobile USSD-PUSH API & Card API**

For businesses that need to collect payments programmatically. A betting company can use the Mobile USSD-PUSH API to collect bets from mobile money wallets, or the Card API for card payments.


**Mobile Payouts API & Bank Payout API**

Businesses that need to automate payments to multiple recipients. A microfinance institution can use the Mobile Payouts API and Bank Payout API to send loan disbursements directly from their loan management systems to borrowers' mobile money wallets and bank accounts.
