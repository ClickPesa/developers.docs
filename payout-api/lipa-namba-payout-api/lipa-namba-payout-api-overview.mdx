...
To send a Lipa Namba payout without code, use [Single Payout](/dashboard/disbursement/single-payout) in the Merchant Dashboard (Lipa Namba + provider, with **Verify Name**). Dashboard payouts do not support TanQR scan — use this API for `qrCode`.
