...
<Tip>
To use the Payment API, create an application and enable payment features under [Developers settings](/dashboard/settings/developers). View collections under [Payment Transactions](/dashboard/transactions/payments). See [API Integration Setup](/application/api-application-setup).
</Tip>
