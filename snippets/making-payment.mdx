...
1. Piga `*150*60#`
2. Chagua Chaguo `6` --- **Huduma za Kifedha / Financial Services**
3. Chagua Chaguo `6` --- **SACCOS and MFI**
4. Chagua Chaguo `1` --- **MFI**
5. Chagua Chaguo `5` --- **A-G**
6. Chagua Chaguo `8` --- **ClickPesa**
7. Ingiza namba ya Kumbukumbu --- **[{controlNumber}]**
8. Weka Kiasi
9. Chagua `1` --- **(Ndio) Kuthibitisha**
10. Weka PIN
  </Tab>
...
5. Weka namba ya Kumbukumbu ya Malipo --- **[{controlNumber}]**
6. Weka Kiasi
...
4. Bonyeza **Kumbukumbu** na Weka **[{controlNumber}]**
5. Weka Kiasi
6. Bonyeza **Endelea**
...
### [{operation} via Mixx By Yas](#pay-via-mixx-by-yas)
<Tabs>
  <Tab title="Mixx By Yas USSD">
1. Piga `*150*01#`
...
6. Weka kiasi
7. Bonyeza **Endelea**
8. Ingiza Namba ya Siri ya Mixx By Yas
9. Bonyeza **Thibitisha**
  </Tab>
</Tabs>

### [{operation} via Halopesa](#pay-via-halopesa)
<Tabs>
...
5. Bonyeza **ENDELEA**
6. Weka kumbukumbu namba --- **[{controlNumber}]**
7. Weka kiasi
8. Bonyeza **ENDELEA**
