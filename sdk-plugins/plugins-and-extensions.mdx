...
<Card
  ...
  icon="shopping-cart"
  href="https://github.com/ClickPesa/ClickPesa-WooCommerce-Plugin-Release/releases"
>
...
<Card
  title="Python SDK"
  icon="code"
  href="https://github.com/JAXPARROW/clickpesa-python-sdk"
>
...
<Card
  title="Node.js SDK"
  icon="code"
  href="https://www.npmjs.com/package/clickpesa-nodejs-sdk"
>
  TypeScript-first Node.js SDK for the ClickPesa API. Collections, disbursements, BillPay, hosted links, account, and exchange rates, with auto token management, checksum injection, retries, and webhook verification.

  **Built by:** Deogratius Denis Mbombwe
</Card>
