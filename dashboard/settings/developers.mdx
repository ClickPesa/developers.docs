...
<Note>
If KYC is not yet approved, API access is limited to **100 calls per day** (including token generation). The limit resets at midnight East Africa Time. Complete [KYC](/dashboard/settings/kyc) to remove this cap.
</Note>
