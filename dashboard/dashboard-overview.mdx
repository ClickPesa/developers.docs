...
- **No-code collections** — Create [Payment Pages](/dashboard/payment-pages), [E-Invoices](/dashboard/e-invoice), manage [Checkout Links](/dashboard/checkout-links), activate [TanQR/Lipa Namba](/tan-qr/lipa-namba-setup) and [BillPay](/dashboard/customers), or collect on a schedule with [CRDB Direct Debit Payment Plans](/crdb-direct-debit/payment-plans).
...
3. **Collect or disburse** — Use dashboard features or integrate via [Hosted Checkout](/checkout/checkout-overview), [BillPay](/bill-pay/bill-pay-overview), [TanQR/Lipa Namba](/tan-qr/tan-qr-overview), [Mobile USSD-PUSH API](/payment-api/mobile-money-payment-api/mobile-money-payment-api-overview), [Card API](/payment-api/card-payment-api/card-payment-api-overview), [Mobile Payouts API](/payout-api/mobile-money-payout-api/mobile-money-payout-api-overview), [Bank Payout API](/payout-api/bank-payout-api/bank-payout-api-overview), or [Lipa Namba Payout API](/payout-api/lipa-namba-payout-api/lipa-namba-payout-api-overview).
