---
title: "Single Payout"
description: "The Single Payout feature provides a straightforward way to initiate individual payouts to recipients, making it convenient for organizations to disburse..."
---
...
1. **Simplicity:** Easily initiate individual payouts without the need for batch files.
2. **Real-time Control:** Make on-the-spot payments when necessary.
3. **Flexibility:** Suitable for one-time or occasional transactions.
...
5. **Immediate Notifications:** Recipients receive notifications upon successful transactions.
...
**Note**: The notification will be delivered to recipient will be delivered using default language you have set on [General settings](/dashboard/settings/profile).
