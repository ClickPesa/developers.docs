...
You can specify the **amount**, **payment mode** (full or partial), a **max total** that can be collected, a **custom reference**, and other metadata.
</Card>
...
You can include **customer name**, **bill description**, **amount**, a **max total** that can be collected, and **payment mode**.
...
<Note>
You can pass your own references that already exist in your system (for example invoice IDs, loan IDs or order numbers) as `billReference`. That value becomes the customer-facing control number. It must be unique within ClickPesa for your account.
</Note>
...
Use this endpoint to retrieve full details of a BillPay Control Number, including amount, max total, how much can still be collected, reference, linked customer and invoice details.
...
<Card
 ...
 Use this endpoint to update a BillPay Control Number Details: **billStatus**, **billAmount**, **billMaxCollectionAmount**, **billDescription**, or **billPaymentMode**. Useful in reusing the reference number without recreating.
</Card>