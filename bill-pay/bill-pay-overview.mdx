...
To access your BillPay-Namba, log in to [Merchant Dashboard](https://merchant.clickpesa.com), navigate to **Settings** → **Collection**, and scroll down to the **Collection Tools** under **Offline Payments Collection** section.
