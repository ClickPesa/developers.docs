...
ClickPesa BillPay is a payment solution that enables you to receive instant payments both via web checkout and billpay via multiple channels,
...
To access your BillPay-Namba, log in to [Merchant Dashboard](https://merchant.clickpesa.com), navigate to **Settings** → **Collection**, and scroll down to the **Collection Tools** under **BillPay Payments Collection** section.
...
<CardGroup cols={2}>
  ...
  >
    Generate a BillPay Control Number using ClickPesa’s BillPay-Namba and Order
    Reference
  </Card>
  <Card
