...
To access your BillPay-Namba, log in to [ClickPesa Dashboard](https://merchant.clickpesa.com), navigate to **Settings** → **Collection**, and scroll down to the **Collection Tools** under **Offline Payments Collection** section.
