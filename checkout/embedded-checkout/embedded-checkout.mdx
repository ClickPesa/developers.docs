...
2. **Add ClickPesa Checkout on Your Platform**
   ...
   - [React Application Integration](#): Embed ClickPesa's Checkout component in your React application.
   - [HTML/JavaScript Integration](#): Use ClickPesa's Checkout script to integrate the checkout in a plain HTML/JavaScript setup.