...
After submission, the mandate starts as **REQUESTED**. The customer receives notifications with instructions on how to approve the mandate via their CRDB SIM-Banking App. When the mandate becomes **ACTIVE**, scheduled collections can begin. If the mandate is **REJECTED**, installments will not collect.
