...
- **[Invoice](/knowledge-base/collection/e-invoice)**
- **[Payment Page](/knowledge-base/collection/payment-pages)**
- **[Checkout Link](/knowledge-base/collection/checkout-link)**
...
1. **Merchant Offline Reference**  
   This provides a static reference number for the merchant, which customers can use to pay via mobile money. Detailed instructions on how to use this reference are available on [here](/knowledge-base/collection/offline-payments).
2. **Customer Offline Reference**  
   Similar to the merchant reference, but unique for each customer. Detailed instructions on using customer references are available [here](/knowledge-base/collection/offline-payments).
3. **Order Reference**  
