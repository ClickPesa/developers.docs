...
| Mobile Network Name | [MOBILE MONEY PROVIDER NAME](/knowledge-base/disbursement/bulk-payouts#mobile-money-provider-names) | TIGO PESA |
...
**Note**: The notification will be delivered to recipient will be delivered using default language you have set on [General settings](/knowledge-base/settings/profile).
...
6. Once payout is successful initiated you will receive [notification](/knowledge-base/notifications/notifications) via email or your dashboard.
...
9. To export payouts,
   - In the Payouts Table, locate and click the “Export” button at the far right. this will take you to the [payout export page](/knowledge-base/data-export/payout-export).
...
4. Can A Team member initiate or approve a payout?
   - Yes, we support assigning payout roles to team members for initiating or approving single payouts. [Learn More](/knowledge-base/settings/disbursement)
