...
3. **Generate Hosted Payout Link** - [Payout Link API](/api-reference/disbursement/generate-payout-link/generate-payout-link) - Use API to generate a hosted checkout link.
